...
$modal = function (options) {
    ...
    function _createModal(options) {
        ...
        modalHTML = modalTemplate.replace('{{title}}', options.title || 'К сожалению ваша учетная запись заблокирована!');
        modalHTML = modalHTML.replace('{{content}}', options.content || 'Для более подробной информации свяжитесь с нами по почте.');
