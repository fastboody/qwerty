                ...
                <div id="form">
                    <div class="mb-3">
                        ...
                        <vue-multiselect
                            ...
                            placeholder="Адрес"
                            select-label=""
                            deselect-label="Нажмите чтобы снять выбор"
                  ...
                  <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label">Ссылка на источник</label>
                        <input type="text" name="link_source" class="form-control" id="exampleInputPassword1"
                               placeholder="Ссылка на источник" value="Ссылка отсутствует">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control123" name="images[]" multiple>
                        ...
                        <div class="col-md-6 offset-md-4">
                            <div class="form-check">
                                ...
                                <label class="form-check-label" for="politics">
                                    Нажимая на кнопку "Отправить сообщение", я даю <font color="#b22222"><a href="uploads/politica.pdf">согласие на обработку персональных данных.</a></font>
                                </label>
                            </div>
                        </div>
                    </div>
                    <input type="hidden" name="title" value="Текст отсутствует">
                    <button type="submit" name="submit" disabled="" class="btn btn-primary">Отправить сообщение</button>
                </div>
            </form>
             </div>
        </div>
