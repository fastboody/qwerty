        ...
        <div class="card">
            <div class="card-body">
                <div class="border p-4 rounded">
                    ...
                    <hr>
                    <form action="{{ route('updatesentmessage') }}" method="post" enctype="multipart/form-data">
...
{{--            </div>--}}
{{--        @endif--}}
{{--        <form class="add_form" action="/updatesentmessage" method="post" enctype="multipart/form-data">--}}
{{--            @csrf--}}
